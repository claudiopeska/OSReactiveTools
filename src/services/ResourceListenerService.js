import { addResource } from '@/store/store.js';
...
function getScreenActionRegex(value) {
    //reset regex index
        ...
        resource.getContent((content) => {
            ...
            resourceObject.dataActions = lines.reduce((linesResult, line, index) => {
                ...
                if (dataActionName) {
                    ...
                    //load client actions
                    var clientActionName = getScreenActionRegex(line);
                    if (clientActionName) {
...
export default new ResourceListenerService();